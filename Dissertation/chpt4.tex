...
In the next section a discussion will be presented on what characteristics the tabu search algorithm posses which sets it apart from other optimisation algorithms.
...
\centering
	...
	\end{tabular}
\caption{TS on Cost 259 Benchmark}
\end{table}
