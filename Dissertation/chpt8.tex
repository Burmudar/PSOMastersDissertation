...
The following equation is used to acertain the Z statistic based on the average and standard deviation produced by the FAP PSO with velocity method 1 and 2.
\begin{equation}
