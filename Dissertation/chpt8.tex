...
\item Each velocity method was also paired with one of the three global selection schemes namely, standard (traditional PSO global best selection), building Gbest with Cells and building a Gbest with TRX's.
\end{itemize}
...
\centering
    ...
    \bottomrule
	\end{tabular}
\caption{Overall Siemens1 results with velocity method 1}
\label{tab:siem1m1}
\end{table}
\begin{table}[H]
\centering
    ...
    \bottomrule
	\end{tabular}
\caption{Overall Siemens1 results with velocity method 2}
\label{tab:siem1m2}
\end{table}
\begin{table}[H]
\centering
...
\centering
    ...
    \bottomrule
	\end{tabular}
\caption{Overall Siemens2 results with velocity method 1}
\label{tab:siem2m1}
\end{table}
\begin{table}[H]
\centering
    ...
    \bottomrule
	\end{tabular}
\caption{Overall siemens2 results with velocity method 2}
\label{tab:siem2m2}
\end{table}
\begin{table}[H]
\centering
...
\centering
    ...
    \bottomrule
	\end{tabular}
\caption{Overall siemens3 results with velocity method 1}
\label{tab:siem3m1}
\end{table}
\begin{table}[H]
\centering
    ...
    \bottomrule
	\end{tabular}
\caption{Overall siemens3 results with velocity method 2}
\label{tab:siem3m2}
\end{table}
\begin{table}[H]
\centering
...
\centering
    ...
    Algorithm & \multicolumn{3}{c}{co-channel} & \multicolumn{3}{c}{adj-channel} & \multicolumn{3}{c}{TRX}\\
              ...
              & max & std & max\\
    \midrule
    Best FAP PSO & 0.57 & 0.01 & 0.03 & 0.08 & 0.00 & 0.00 & 0.57 & 0.07 & 0.07\\
...
\begin{tabular}{ccccc}
	\toprule
	Algorithm & Siemens1 & Siemens2 & Siemens3 & Siemens4 \\
    \midrule
...
For each of the presented algorithm variants that are presented the average, standard deviation and varaince was calculated. As mentioned in the introduction of this chapter, each algorithm variant was executed 20 times. The statistics presented are thus not based on a single run but on this set of 20 results for each variant. The mininum achieved is the lowest minimum among the 20 result set.
...
In the results sections two tables were presented in addition to the table depicting the overall algorithm performance. As discussed in introduction, each algorithm variant was executed 20 times. These two additional tables, depicts the interference statistics the single best result out of all the produced different algorithm results.
\section{Summary}
