...
In addition to checking if a frequency is tabu, resolve collisions also handles the case where if a tranceiver within a cell has the same frequency as a different transceiver within the same cell. This process occurs on line 
