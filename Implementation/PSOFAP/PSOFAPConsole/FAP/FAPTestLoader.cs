                    ...
                    case Tag.FORMAT_START:
                        {
                            ...
                            {
                                throw new InvalidFAPFileException("The Format type of the given assignment " +
                                	"file is not of an \"ASSIGNMENT\" type");
                            }
                        }
                        break;
                    case Tag.GENERATION_INFORMATION_START:
                        {
                            ...
                            {
                                throw new InvalidScenarioIDException("The given assignment file scenario id doesn't " +
                                	"match the problem file scenario id");
                            }
                        }
                        break;
                    ...
                    case Tag.CELL_ID:
                        {
                            ...
                            {
                                System.Console.WriteLine("Assignment incosistency: Must assign frequency to Cell with " +
                                	"ID: {0} but found {1}", ((Num)token).Value.ToString(), cell.CellID);
                            }
                            freqIndex = 0;
                        }
                        break;
